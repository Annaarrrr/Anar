...
const createIcon = (
  ...
  const Component = React.memo(({ size = 24, color = '#2D211A', style }: IconProps) => (
    <Svg
      width={size}
      height={size}
      viewBox={viewBox}
...
export const BellIcon = createIcon('BellIcon', (color) => (
  <G stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" fill="none">
    {/* Main Bell Body */}
    <Path d="M 18 8.5 A 6 6 0 0 0 6 8.5 C 6 15 3.5 17 3.5 17 L 20.5 17 C 20.5 17 18 15 18 8.5 Z" />
    {/* Bell Clapper */}
    <Path d="M 10.3 20 A 2 2 0 0 0 13.7 20" strokeWidth={2.2} />
    {/* Sketchy internal reflection line */}
    <Path d="M 7.5 9.5 C 7.5 13.5 5.5 15.5 5.5 15.5 L 18.5 15.5" strokeWidth={1} opacity={0.45} />
  </G>
));
...
// ─── 31. AppleLogo ───────────────────────────────────────────────────────────
export const AppleLogo = React.memo(({ size = 18, color = '#000000' }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
    <Path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 4.17c.66-.81 1.11-1.93.99-3.06-.96.04-2.13.64-2.82 1.45-.6.7-1.13 1.84-.99 2.94.1.08.2.12.3.12.86 0 1.86-.64 2.52-1.45z" />
  </Svg>
));
